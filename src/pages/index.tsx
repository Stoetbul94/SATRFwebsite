...
import {
  ...
  fetchOpenEventsServer,
} from '@/lib/server/homepageData';

const OlympicCountdown = dynamic(() => import('@/components/OlympicCountdown'), {
  loading: () => <div className="h-24 bg-gray-50" aria-hidden />,
});

const SportCollageSection = dynamic(() => import('@/components/home/SportCollageSection'), {
  loading: () => <div className="h-48 bg-[#070d1e]" aria-hidden />,
});

const FromTheFiringLineSection = dynamic(() => import('@/components/home/FromTheFiringLineSection'), {
  loading: () => <div className="h-64 bg-gray-50" aria-hidden />,
});
...
export default function Home({ initialStats, initialEvents }: HomeProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-satrf-navy mb-2">{stats.events}</div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-satrf-navy mb-2">{stats.news}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 items-center justify-items-center">
            {[
              ...
              { name: 'SATRF', logo: 'SATRFLOGO.webp' },
            ].map((partner, index) => (
              <div
                key={index}
...
export const getStaticProps: GetStaticProps<HomeProps> = async () => {
  const [initialStats, initialEvents] = await Promise.all([
    fetchDashboardStatsServer(),
    fetchOpenEventsServer(3),
  ]);

  return {
    props: {
      initialStats: initialStats ?? FALLBACK_HOME_STATS,
      initialEvents,
    },
    revalidate: 60,
  };
