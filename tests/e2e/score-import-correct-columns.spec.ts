...
// Test data with correct column names that match the component's processing
const VALID_SCORE_DATA = [
  {
    ...
    'Club': 'SATRF Club A',
    'Division/Class': 'Open', // Valid division - this becomes "division/class"
...
test.describe('Score Import with Correct Column Names', () => {
  let validExcelFile: string;

  test.beforeAll(async () => {
    // Create test file
    validExcelFile = createTestFile(VALID_SCORE_DATA, 'correct-columns-scores.xlsx');
  });
